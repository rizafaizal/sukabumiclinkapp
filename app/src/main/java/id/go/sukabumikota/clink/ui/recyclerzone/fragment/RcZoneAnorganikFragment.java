 ...
 */
public class RcZoneAnorganikFragment extends Fragment {
    ...
    public RcZoneAnorganikFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_rc_zone_anorganik, container, false);
    }
    ...
    private void getResultListRecyclerZone(){
        ...
        mApiService.getAllRecyclerZoneSelect("Anorganik").enqueue(new Callback<ResponseRecyclerZone>() {
            @Override
            public void onResponse(Call<ResponseRecyclerZone> call, Response<ResponseRecyclerZone> response) {
                if (response.isSuccessful()){
                    ...
                    if (error.equals(true)) {
                        String msg = "Tidak ada data Recycler Zone Anorganik!";
                        onNothingData(msg);
                    } else {
                        if (allResponseRecyclerZones == null) {
                            String msg = "Kesalahan Data Recycler Zone Anorganik!";
                            onNullData(msg);
                        } else {
                    ...
                    loading.dismiss();
                    String msg = "Gagal mengambil data Recycler Zone Anorganik";
                    onErrorServer(msg);
                }
            }
