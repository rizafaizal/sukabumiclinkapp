...
public class AdapterBoulevard extends RecyclerView.Adapter<AdapterBoulevard.AdapterBoulevardHolder> {
    ...
    public AdapterBoulevard(Context mContext, List<AllResponseBoulevard> allResponseBoulevards) {
    ...
    @NonNull
    @Override
    public AdapterBoulevard.AdapterBoulevardHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).
                inflate(R.layout.list_boulevards, parent, false);
        return new AdapterBoulevardHolder(itemview);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterBoulevard.AdapterBoulevardHolder holder, int position) {
    ...
    public class AdapterBoulevardHolder extends RecyclerView.ViewHolder {
        TextView tv_title;
        ImageView img_boulevard_dash;
        LinearLayout view_bg_boulevard_dash;
        CardView cv_boulevarddash;

        public AdapterBoulevardHolder(@NonNull View itemView) {
            super(itemView);

            tv_title = itemView.findViewById(R.id.tv_title_boulevard_dash_s);
            img_boulevard_dash = itemView.findViewById(R.id.img_boulevard_dash_s);
            view_bg_boulevard_dash = itemView.findViewById(R.id.view_bg_boulevard_dash_s);
            cv_boulevarddash = itemView.findViewById(R.id.cv_boulevarddash_s);
        }
    }
